...
export declare class NextS3MediaStore implements MediaStore {
    s3Bucket: string;
    s3ReadUrl: string;
    s3ServerSideEncryption: string;
    s3StsToken: STS.Types.GetFederationTokenResponse | null;
    s3StsTokenCreatedAt: number | null;
    accept: string;
